...
export async function reloadFunc() {
  ...
  [this.model, this.state, this.simulation, this.bodies, this.lights] =
    await loadSceneFromURL(this.mujoco, "Carm/C-arm.xml", this);
...
export function setupGUI(parentContext) {
  ...
  parentContext.updateGUICallbacks.push((model, simulation, params) => {
    ...
    parentContext.camera.position.set(2.5, 1.7, 1.7);
    parentContext.controls.target.set(0, 0.7, 1);
...
export async function downloadExampleScenesFolder(mujoco) {
  let allFiles = [
    // "22_humanoids.xml",
    "Carm/C-arm.xml",
    "Carm/X-ray_visual.obj",
    "Carm/X_rotation_base.obj",
    "Carm/Y_rotation_base.obj",
    "Carm/base.obj",
    "Carm/bed.obj",
    // "adhesion.xml",
